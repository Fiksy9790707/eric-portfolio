...
This file is a short entry point for reviewers who open the repository first.
...
Publish `AI-Campus-Assistant` as a standalone public repository and then update:

1. GitHub Profile README
2. `public/resume.md`
3. `public/evidence.md`
4. local resume PDF / Markdown

Until that repository exists, the correct wording is "public portfolio evidence artifact available" or "publish-ready package prepared", not "standalone public repository available".
